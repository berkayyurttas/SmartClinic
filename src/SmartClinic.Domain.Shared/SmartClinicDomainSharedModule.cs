...
public class SmartClinicDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        SmartClinicGlobalFeatureConfigurator.Configure();
        SmartClinicModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<SmartClinicDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<SmartClinicResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/SmartClinic");

            options.DefaultResourceType = typeof(SmartClinicResource);
        ...
        {
            options.MapCodeNamespace("SmartClinic", typeof(SmartClinicResource));
        });
    }
}
